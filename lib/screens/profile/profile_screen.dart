      ...
      child: Scaffold(
        ...
        body:  
          ...
          gradient: LinearGradient(
              ...
              start_color2  ,
                end_color2])),
               child: StreamBuilder(stream:controller.getUserInfo(auth.currentUser!.email.toString()),
      ...
      child: Scaffold(
        ...
        body: Padding(
          padding: const EdgeInsets.all(10),
              ...
              mainAxisSpacing: 8,
              crossAxisSpacing: 8,
              itemCount: data[0]['my_saved_posts'].reversed.length,
      ...
      child: Scaffold(
        ...
        body: Padding(
          padding: const EdgeInsets.all(10),
              ...
              mainAxisSpacing: 8,
              crossAxisSpacing: 8,
              itemCount: data[0]['my_posted_posts'].reversed.length,
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    ClipRRect(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                        IconButton(onPressed: (){
                                          controller.removePostFromposts(category_name: data[0]['my_posted_posts'][index]['category']);
                                          controller.removePostFromusers(post_name: data[0]['my_posted_posts'][index]['name']);
                                          controller.removePostfromCategories(category_name: data[0]['my_posted_posts'][index]['category'],name_product: data[0]['my_posted_posts'][index]['name']);
                                          controller.removePostfromPosts(name_product: data[0]['my_posted_posts'][index]['name']);
                                          Navigator.pop(context);
                                          VxToast.show(context, msg: 'Пост был успешно удален');
